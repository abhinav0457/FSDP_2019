# -*- coding: utf-8 -*-
"""
Created on Mon Jun 10 18:30:34 2019
...
for i in orders:
    if i[-1]*i[-2]<100:
        order_summary.append((i[0],i[-1]*i[-2]+10))
    else:
        order_summary.append((i[0],i[-1]*i[-2]))
        
l1=list(map(lambda i:(i[0],i[-1]*i[-2]+10) if i[-1]*i[-2]<100 else (i[0],i[-1]*i[-2]) ,orders))        
